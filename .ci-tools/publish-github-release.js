...
if (!process.env['RELEASE_GH_TOKEN'] ||  process.env['RELEASE_GH_TOKEN'] === null ||  process.env['RELEASE_GH_TOKEN'] == undefined ||  process.env['RELEASE_GH_TOKEN'] == '') {
...
const github_repo_name = process.env['RELEASE_GH_NAMESPACE'] || 'process_engine_runtime';

...
describe('ManagementAPI: GetEventsForCorrelation', () => {
  ...
  describe('Execution', () => {
    ...
    it('should return a correlation\'s events by its correlation_id through the management api', async () => {
    ...
    it('should return an empty Array, if the correlation_id does not exist', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, invalidCorrelationId);
    ...
    it('should return an empty Array, when the user has no access to any of the events', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(restrictedIdentity, invalidCorrelationId);
  ...
  describe('Pagination', () => {
    ...
    it('should apply no limit, an offset of 5 and return 5 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, correlationIdPaginationTest, 5);
    ...
    it('should apply no offset, a limit of 2 and return 2 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, correlationIdPaginationTest, 0, 2);
    ...
    it('should apply an offset of 5, a limit of 2 and return 2 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, correlationIdPaginationTest, 5, 2);
    ...
    it('should apply an offset of 7, a limit of 5 and return 3 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, correlationIdPaginationTest, 7, 5);
    ...
    it('should return all items, if the limit is larger than the max number of records', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, correlationIdPaginationTest, 0, 20);
    ...
    it('should return an empty Array, if the offset is out of bounds', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(defaultIdentity, correlationIdPaginationTest, 1000);
  ...
  describe('Security Checks', () => {
    ...
    it('should fail to retrieve the correlation\'s events, when the user is unauthorized', async () => {
      ...
      try {
        await testFixtureProvider.managementApiClient.getWaitingEventsForCorrelation({}, correlationId);
    ...
    it('should return an empty Array, if the user is not allowed to access any suspended events', async () => {
      ...
      const eventList = await testFixtureProvider
        .managementApiClient
        .getWaitingEventsForCorrelation(restrictedIdentity, correlationId);

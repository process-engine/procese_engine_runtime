...
describe('Management API: GetEmptyActivitiesForCorrelation', () => {
  ...
  const processModelIdNoEmptyActivities = 'test_management_api_emptyactivity_empty';
  const processModelIdCallActivity = 'test_management_api_emptyactivity_call_activity';
